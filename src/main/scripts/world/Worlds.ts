...
import WorldSettings from "../engine/world/WorldSettings";

console.debug("");
console.debug("Worlds");
console.debug("==========");
export default class Worlds {
    public static WORLD: FroggerWorld = Worlds.register(new FroggerWorld(new WorldSettings().addGenerators(ChunkGenerators.GRASS, ChunkGenerators.ROADS, ChunkGenerators.FLOWERS)), "world");
